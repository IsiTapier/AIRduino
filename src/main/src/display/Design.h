...
#define MENU_SECTION_SIZE SIZE((MENU_SECTION_LENGTH - MENU_SLIDER_LENGTH - 2*MENU_MARGIN_RIGHT), (MENU_SECTION_HEIGHT - MENU_MARGIN_VERTICAL), text.length())
#define MENU_SECTION_OLD_SIZE SIZE((MENU_SECTION_LENGTH - MENU_SIDE_LENGTH - 2*MENU_MARGIN_RIGHT), (MENU_SECTION_HEIGHT - MENU_MARGIN_VERTICAL), oldText.length())
...
#define MENU_SIDE_CENTER_X (MENU_SIDE_X + round((MENU_SIDE_LENGTH - MENU_SIDE_THICKNESS)/2))
#define MENU_SIDE_CENTER_Y (MENU_SIDE_Y + round(MENU_SIDE_HEIGHT/2))
#define MENU_SIDE_BAR_X (MENU_SIDE_X + DISPLAY_MARGIN_LEFT)
