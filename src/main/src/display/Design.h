...
#define MENU_START_X (MENU_END_X - MENU_LENGTH)
#define MENU_START_Y MENU_MARGIN
#define MENU_END_X (DISPLAY_LENGTH - MENU_MARGIN)
#define MENU_END_Y (MENU_START_Y + MENU_HEIGHT)
