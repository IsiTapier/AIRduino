...
#define TIME_COLOR (minutes>=20&&COLORED_TIME?TIME_COLOR_CRITICAL:TIME_COLOR_NORMAL)

//State Colors
#define COLOR_STATUS_VENTILATING CYAN
#define COLOR_STATUS_NORMAL (BLACK_MODE) ? GREEN : 0x3DE0//Normal
#define COLOR_STATUS_RISK (BLACK_MODE) ? ORANGE : 0xEBC0//0xFE60 //Risk
#define COLOR_STATUS_WARNING (BLACK_MODE) ? RED : 0x8800//Warning
#define COLOR_STATUS_ALARM RED//MAROON//0xFA27 //Alarm

//Background Colors for V3
#define BACKGROUND_COLOR_STATUS_NORMAL_V3 0x3347
#define BACKGROUND_COLOR_STATUS_RISK_V3 0x83E8
#define BACKGROUND_COLOR_STATUS_WARNING_V3 0x8124
#define BACKGROUND_COLOR_STATUS_ALARM_V3 0x8124
#define BACKGROUND_COLOR_STATUS_VENTILATING_V3 0x3BCE
