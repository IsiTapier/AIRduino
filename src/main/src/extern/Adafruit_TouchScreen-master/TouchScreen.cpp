...
TouchScreen::TouchScreen(uint8_t xp, uint8_t yp, uint8_t xm, uint8_t ym, TFT_eSPI display, uint16_t rxplate) {
  _yp = yp;
  _xm = xm;
  _ym = ym;
  _xp = xp;
...
void TouchScreen::calibration(void) {
  ...
  _display.fillRect(TOUCH_CALIBRATION_BOX_MARGIN, TOUCH_CALIBRATION_BOX_MARGIN, TOUCH_CALIBRATION_BOX_SIZE, TOUCH_CALIBRATION_BOX_SIZE, TOUCH_CALIBRATION_BOX_CALIBRATION_COLOR);
  _display.fillRect(TOUCH_CALIBRATION_BOX_CHANGE_X, TOUCH_CALIBRATION_BOX_MARGIN, TOUCH_CALIBRATION_BOX_SIZE, TOUCH_CALIBRATION_BOX_SIZE, TOUCH_CALIBRATION_BOX_COLOR);
  _display.fillRect(TOUCH_CALIBRATION_BOX_MARGIN, TOUCH_CALIBRATION_BOX_CHANGE_Y, TOUCH_CALIBRATION_BOX_SIZE, TOUCH_CALIBRATION_BOX_SIZE, TOUCH_CALIBRATION_BOX_COLOR);
  _display.fillRect(TOUCH_CALIBRATION_BOX_CHANGE_X, TOUCH_CALIBRATION_BOX_CHANGE_Y, TOUCH_CALIBRATION_BOX_SIZE, TOUCH_CALIBRATION_BOX_SIZE, TOUCH_CALIBRATION_BOX_COLOR);
  ...
  _display.fillRect(TOUCH_CALIBRATION_BOX_MARGIN, TOUCH_CALIBRATION_BOX_MARGIN, TOUCH_CALIBRATION_BOX_SIZE, TOUCH_CALIBRATION_BOX_SIZE, TOUCH_CALIBRATION_BOX_COLOR);
  _display.fillRect(TOUCH_CALIBRATION_BOX_CHANGE_X, TOUCH_CALIBRATION_BOX_MARGIN, TOUCH_CALIBRATION_BOX_SIZE, TOUCH_CALIBRATION_BOX_SIZE, TOUCH_CALIBRATION_BOX_CALIBRATION_COLOR);
  ...
  _display.fillRect(TOUCH_CALIBRATION_BOX_CHANGE_X, TOUCH_CALIBRATION_BOX_MARGIN, TOUCH_CALIBRATION_BOX_SIZE, TOUCH_CALIBRATION_BOX_SIZE, TOUCH_CALIBRATION_BOX_COLOR);
  _display.fillRect(TOUCH_CALIBRATION_BOX_MARGIN, TOUCH_CALIBRATION_BOX_CHANGE_Y, TOUCH_CALIBRATION_BOX_SIZE, TOUCH_CALIBRATION_BOX_SIZE, TOUCH_CALIBRATION_BOX_CALIBRATION_COLOR);
  ...
  _display.fillRect(TOUCH_CALIBRATION_BOX_MARGIN, TOUCH_CALIBRATION_BOX_CHANGE_Y, TOUCH_CALIBRATION_BOX_SIZE, TOUCH_CALIBRATION_BOX_SIZE, TOUCH_CALIBRATION_BOX_COLOR);
  _display.fillRect(TOUCH_CALIBRATION_BOX_CHANGE_X, TOUCH_CALIBRATION_BOX_CHANGE_Y, TOUCH_CALIBRATION_BOX_SIZE, TOUCH_CALIBRATION_BOX_SIZE, TOUCH_CALIBRATION_BOX_CALIBRATION_COLOR);
