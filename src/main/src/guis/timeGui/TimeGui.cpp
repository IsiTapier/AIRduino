...
void TimeGui::initGui() {
    if(gui.equals(TIME_GUI)) {
        ...
        dPrint(stopwatchTitle, DISPLAY_LENGTH*1/6, DISPLAY_HEIGHT/2 + 40, 2, GREY, 4);

        display.pushImage(DISPLAY_LENGTH*3/6 - 32, DISPLAY_HEIGHT/2-32, 64, 64, timerIcon);
        dPrint(timerTitle, DISPLAY_LENGTH*3/6, DISPLAY_HEIGHT/2 + 40, 2, GREY, 4);
        
        display.pushImage(DISPLAY_LENGTH*5/6 - 32, DISPLAY_HEIGHT/2-32, 64, 64, clockIconBig);
        dPrint(clockTitle, DISPLAY_LENGTH*5/6, DISPLAY_HEIGHT/2 + 40, 2, GREY, 4);

        display.fillRect(DISPLAY_LENGTH*1/3, 60, 4, DISPLAY_HEIGHT-60*2, GREY);
        display.fillRect(DISPLAY_LENGTH*2/3, 60, 4, DISPLAY_HEIGHT-60*2, GREY);
