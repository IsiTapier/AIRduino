...
void RandomStudentGui::drawSideBar() {
    ...
    display.pushImage(MIDDLE_LINE_MARGIN+(SIDE_MARGIN-2*MIDDLE_LINE_MARGIN-LINE_THICKNESS-MENU_ICON_LENGTH)/2, TOP_MARGIN+(DISPLAY_HEIGHT-TOP_MARGIN-LINE_MARGIN-LINE_THICKNESS-2*MENU_ICON_HEIGHT)/4, MENU_ICON_LENGTH, MENU_ICON_HEIGHT, studentIcon, BLACK);
    display.pushImage(MIDDLE_LINE_MARGIN+(SIDE_MARGIN-2*MIDDLE_LINE_MARGIN-LINE_THICKNESS-MENU_ICON_LENGTH)/2, DISPLAY_HEIGHT-LINE_MARGIN-MENU_ICON_HEIGHT-(DISPLAY_HEIGHT-TOP_MARGIN-LINE_MARGIN-LINE_THICKNESS-2*MENU_ICON_HEIGHT)/4, MENU_ICON_LENGTH, MENU_ICON_HEIGHT, singleDiceIcon, BLACK);
